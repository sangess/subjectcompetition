      ...
      <el-header height="50px" style="padding: 0">
        <el-menu
          ...
          <el-submenu index="2">
            ...
            <el-menu-item index="/college/comp">竞赛管理</el-menu-item>
            <el-menu-item index="/college/project">项目管理</el-menu-item>
            <el-menu-item index="/college/gonggao">公告管理</el-menu-item>
          </el-submenu>
          <el-menu-item index="/college/home">个人中心</el-menu-item>
          ...
          <el-menu-item type="success" size="small" round icon="el-icon-user-solid"  style="float: right">
            {{this.$store.state.nickname}} <i class="el-icon-user-solid"></i>
          </el-menu-item>
        </el-menu>
      </el-header>
      <el-container>
        <el-aside width="180px" style=" height: 100%; background: linear-gradient(to bottom right,#65FDF0,#1D6FA3)">
          ...
          >
            <el-menu-item index="/college/home">
              <i class="el-icon-user-solid"></i>
              <span slot="title">个人中心</span>
            </el-menu-item>
            <el-menu-item index="/college/index">
              <i class="el-icon-menu"></i>
              <span slot="title">首页</span>
            </el-menu-item>
            <el-menu-item index="/college/project">
              <i class="el-icon-files"></i>
              <span slot="title">项目管理</span>
            </el-menu-item>
            <el-menu-item index="/college/work">
              <i class="el-icon-edit-outline"></i>
              <span slot="title">作品管理</span>
            </el-menu-item>
            <el-menu-item index="/college/comp">
              <i class="el-icon-files"></i>
              <span slot="title">竞赛列表</span>
            </el-menu-item>
            <el-menu-item index="/college/apply">
              <i class="el-icon-bank-card"></i>
              <span slot="title">学院端申请管理</span>
            </el-menu-item>
            <el-menu-item index="/college/xinxi">
              <i class="el-icon-postcard"></i>
              <span slot="title">信息管理</span>
            </el-menu-item>
            <el-menu-item index="/college/tongji">
