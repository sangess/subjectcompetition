    ...
    <el-card style="width: 100%; height:1200px">
      ...
      <div>
        <div style="text-align:center;">
          <h1 style="font-size: 28px;">添加新竞赛</h1>
        </div>
          ...
          <div class="body_form" >
            <el-form label-position="right" label-width="150px" :model="formData" ref="formData" :rules="rules" >
              ...
              <el-form-item style="margin-top: 30px;margin-bottom: 30px;">
                <el-button style="float:left;width: 250px" type="primary" @click="立即创建('formData')">立即创建</el-button>
          ...
          that.$axios
            ...
            .then(function(response) {
              ...
              that.$message({
                ...
                type: response.data == "添加成功！" ? "success" : "error"
              });
              that.$router.back(-1);
            })
