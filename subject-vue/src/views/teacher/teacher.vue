    ...
    <el-container>
      <el-header height="50px" style="padding: 0">
        <el-menu
          ...
          <el-menu-item index="1"> <div style="height:100%;width:239px;font-size: 17px">
            <img style="height: 30px;" src="../../assets/img/6310.png" /> 学科竞赛管理系统
          </div></el-menu-item>
          <el-submenu index="2">
            <template slot="title">我的管理</template>
            <el-menu-item index="/teacher/comp">竞赛管理</el-menu-item>
            <el-menu-item index="/teacher/project">项目管理</el-menu-item>
            <el-menu-item index="/teacher/gonggao">公告管理</el-menu-item>
          </el-submenu>
          <el-menu-item index="/teacher/home">个人中心</el-menu-item>
          ...
          <el-menu-item type="success" size="small" round icon="el-icon-user-solid"  style="float: right">
            {{this.$store.state.nickname}} 老师<i class="el-icon-user-solid"></i>
          </el-menu-item>
        </el-menu>
      </el-header>
      <el-container>
        <el-aside width="180px"style="
          background: linear-gradient(to bottom right,#65FDF0,#1D6FA3);">
          <el-menu
                  :default-active="this.$router.path"
                  router
                  text-color="1D6FA3"
          ...
          >
            ...
            <el-menu-item index="/teacher/project">
              <i class="el-icon-files"></i>
              <span slot="title">项目管理</span>
            </el-menu-item>
            <el-menu-item index="/teacher/comp">
              <i class="el-icon-files"></i>
              <span slot="title">竞赛列表</span>
            </el-menu-item>
            <el-menu-item index="/teacher/apply">
              <i class="el-icon-bank-card"></i>
              <span slot="title">我的申请管理</span>
            </el-menu-item>
            <el-menu-item index="/teacher/xinxi">
